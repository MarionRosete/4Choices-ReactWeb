...
function Attendees() {
    ...
    const handleLogin=()=>{
      const url = `http://localhost:8000/api/dashboard/attendeesExam/${code}`
        fetch(
          url,
            {
            ...
            .then(resjson=>{
                  if(resjson.success===true){
                    function shuffle(array) {
                      ...
                      history.push(
                        {
                          pathname:"/AttendeesLobby", 
                          state:
                            {
                            status:resjson.success,subject:resjson.exam,code:resjson.code,
      ...
      <div className="flex bg-blue-200 p-2 items-center justify-center w-screen h-screen">
        <div className="space-y-5 md:grid md:grid-cols-2 md:justify-center shadow-lg rounded-2xl bg-white p-4">
          <div className="place-items-center md:p-5 text-center mt-1">
                    <p className="text-2xl px-5 py-10">
                      Logo Here
                    </p>
                    ...
                    <div>
                      ...
                      <input className="mb-5 md:ml-12 box-border border focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-sm pl-14 py-2 w-80 h-11.5" 
                        type="text" 
