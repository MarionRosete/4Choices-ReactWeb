          ...
          {showBoard ? (
				...
				<div className='text-blue-900  bg-blue-200 justify-center items-center lg:p-24 p-5 space-y-4'>
                    <div className='flex justify-center items-center gap-x-2'>
                        <p className='md:text-2xl'>
                            You have reach the end of exam
                        </p>
                    ...
                    <div className='flex justify-center space-x-3'>
                        ...
                        <button className='bg-red-900 rounded-md px-1 text-white hover:bg-red-600' onClick={()=>{
                            fetch(`http://localhost:8000/api/dashboard/delete/${code}`,
                                {headers: { 
            ...
            <div className="lg:px-40 py-5">
                <div className="text-blue-900  bg-blue-200 ">
                    ...
                    <div className=" flex justify-center items-center lg:p-24"> 
