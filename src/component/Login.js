    ...
    const handleLogin=(event)=>{
        ...
        return (
          <>
            ...
            <div className="flex bg-white mm:bg-blue-200 justify-center w-screen h-screen text-gray-700">
                <div className="flex flex-row lg:w-3/4 mm:shadow-lg m-8 rounded-2xl bg-white lg:bg-gradient-to-r lg:from-white50 lg:to-offcyan50 py-4 px-4 lg:px-0 max-w-3xl items-stretch">
                      ...
                      <div className="flex-1 text-center">
                          <form onSubmit={handleLogin}>
                              ...
                              <button className="mt-2 mb-3 rounded border-2 px-4 py-1 mb-2 w-72 sm:w-80">
                              ...
                              <div className="mt-5">
                                  ...
                                  <input className="box-border border focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-sm p-2 my-2 w-72 sm:w-80" type="email" placeholder="Email"  value={email} onChange={(e)=>setEmail(e.target.value)}/><br></br>
                                  <input className="box-border border focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-sm p-2 my-2 w-72 sm:w-80" type="password" placeholder="Password"  value={password} onChange={(e)=>setPassword(e.target.value)} /><br></br>
                                  <button className="rounded-sm bg-blue-500 text-white font-bold font-sans p-2 w-72 sm:w-80 ">Sign In</button>
                              </div>

                              <div className="flex justify-between py-3 text-blue-500 text-xs w-72 sm:w-80 m-auto">
                      ...
                      <div className="hidden lg:flex flex-1 justify-center">
                          <div className="my-auto font-bold text-lg">something logo</div>
                      </div>
                </div>
            </div>
